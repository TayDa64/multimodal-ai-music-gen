...
def _guitar_patch() -> InstrumentPatch:
    return _make_patch(
        ...
        synthesis_voice=_make_voice(
            ...
            filter_envelope=EnvelopeSpec(attack_ms=2.0, decay_ms=140.0, sustain_level=0.5, release_ms=120.0, amount=2200.0),
            velocity_map=VelocityMap(amp=1.0, cutoff_delta_hz=1400.0, transient_level=1.0, noise_level=1.0),
...
def _keys_patch() -> InstrumentPatch:
    return _make_patch(
        ...
        synthesis_voice=_make_voice(
            ...
            filter_envelope=EnvelopeSpec(attack_ms=1.0, decay_ms=350.0, sustain_level=0.35, release_ms=200.0, amount=3000.0),
            velocity_map=VelocityMap(amp=1.0, cutoff_delta_hz=3500.0, transient_level=1.0, noise_level=1.0),
...
def _bass_patch() -> InstrumentPatch:
    return _make_patch(
        ...
        synthesis_voice=_make_voice(
            ...
            filter_envelope=EnvelopeSpec(attack_ms=3.0, decay_ms=100.0, sustain_level=0.55, release_ms=120.0, amount=1200.0),
            velocity_map=VelocityMap(amp=1.0, cutoff_delta_hz=600.0, transient_level=1.0, noise_level=0.5),
...
def _brass_patch() -> InstrumentPatch:
    return _make_patch(
        ...
        synthesis_voice=_make_voice(
            ...
            filter_envelope=EnvelopeSpec(attack_ms=12.0, decay_ms=120.0, sustain_level=0.6, release_ms=100.0, amount=2500.0),
            velocity_map=VelocityMap(amp=1.0, cutoff_delta_hz=4000.0, transient_level=1.0, noise_level=1.0),
